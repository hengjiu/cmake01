...
// configuration step. It creates a namespace called `cmake01`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake01::cmake::project_name, cmake01::cmake::project_version) };
